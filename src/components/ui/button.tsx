  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-primary text-white font-semibold shadow-glow hover:shadow-elegant transform hover:scale-105 transition-bounce",
        agent: "bg-card text-card-foreground border border-border hover:shadow-card hover:border-primary/30 transition-smooth",
        glow: "bg-primary text-primary-foreground shadow-glow hover:shadow-elegant animate-pulse-glow",
      },
      size: {
